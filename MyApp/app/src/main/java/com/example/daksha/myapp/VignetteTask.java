...
import static com.example.daksha.myapp.ImageEditTaskActivity.toVignette;

/**
 * Created by vinaynoah on 03/11/16.
 */
public class VignetteTask extends AsyncTask<Bitmap, String, Bitmap> {
    ...
    public VignetteTask(Activity activity){
    ...
    protected Bitmap doInBackground(Bitmap... image) {
        ...
        Bitmap vignetteTaskImage = toVignette(image[0]);
        return vignetteTaskImage;
    }
